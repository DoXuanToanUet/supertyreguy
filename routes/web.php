...
Route::get('/copy-data', 'ScrapItemController@copy');
...
// ************************************ USER PANEL **********************************************
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::get('/register', 'Auth\User\RegisterController@showForm')->name('user.auth.register');
...
// ************************************ FRONTEND **********************************************
        ...
        // -------------CART-SERVICE-COUNT-----------------
        Route::get('/product/cart/service', 'Front\CartController@cartServiceAdd')->name('product.service');
        ...
        //-------------ORDER BOOKING--------
        Route::get('/checkout/order', 'Front\CheckoutController@orderPlace')->name('front.checkout.order');
        Route::post('/checkout/order', 'Front\CheckoutController@orderBookingPost')->name('front.checkout.order.submit');
