      ...
      <div class="card-body">
        <div class="shopping-cart-footer">
            ...
            <div class="text-right column text-lg">
              <div>
                <span class="text-muted">{{__('Subtotal')}}: </span><span class="text-gray-dark">{{PriceHelper::setCurrencyPrice($cartTotal - (Session::has('coupon') ? round(Session::get('coupon')['discount'],2) : 0))}}</span>
              </div>
              <div>
              <span class="text-muted">{{__('GST Price')}}: </span><span class="text-gray-dark">{{PriceHelper::setCurrencyGSTPrice($cartTotal - (Session::has('coupon') ? round(Session::get('coupon')['discount'],2) : 0))}}</span>
              </div>
            </div>
            <!-- <div class="text-right column text-lg"><span class="text-muted">{{__('GST Price')}}: </span><span class="text-gray-dark">{{PriceHelper::setCurrencyPrice($cartTotal - (Session::has('coupon') ? round(Session::get('coupon')['discount'],2) : 0))}}</span></div> -->
