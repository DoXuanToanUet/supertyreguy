                            ...
                            <input type="hidden" value="normal" name="item_type">
                                <div class="row justify-content-center">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label for="discount_price">{{ __('Markup Price') }}
                                                    *</label>
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" id="discount_price"
                                                        ...
                                                        placeholder="{{ __('Enter Maker Price') }}"
                                                        min="1" step="0.1"
                                            ...
                                            <div class="form-group">
                                                <label for="marketing_price">{{ __('Price with GST') }}
                                                    *</label>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span
                                                    ...
                                                    <input type="text" id="marketing_price"
                                                        name="marketing_price" class="form-control"
                                                        placeholder="{{ __('Enter Marketing Price') }}"
                                                        min="1" step="0.1"
                                                        value="{{ round($item->marketing_price * $curr->value,2) }}" >
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function(){
        $("#previous_price").on("input", function() {
        var category = $('#category_id').find(":selected").text();
        let prev_data=$(this).val();
        
        if(category=="Tyres"){
            let gst=(parseInt(prev_data)+(parseInt(prev_data)*.35));
            if($(this).val()==''){
                $('#marketing_price').val(0);
                $('#discount_price').val(0);
            }else{
                $('#marketing_price').val(parseInt(gst)+parseInt(gst)*.15);
                $('#discount_price').val(gst);
            }
        }else if(category=="Wheels"){
            let gst=(parseInt(prev_data)+(parseInt(prev_data)*.5));
            if($(this).val()==''){
                $('#marketing_price').val(0);
                $('#discount_price').val(0);
            }else{
