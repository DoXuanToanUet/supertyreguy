                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-muted">Additional Cost Select:</span>
                                        @endif
                                        @if($order->additional_cost)
                                            @foreach(json_decode($order->additional_cost,true) as $key => $value)
                                             <span> {{$key}} </span>
                                            @endforeach
                                        @endif
                                ...
                                <div class="gd-responsive-table">
                                    ...
                                    @endforeach
                                        ...
                                        <td class="px-0 text-right border-top border-top-2" colspan="5">
                                            <span class="h3">
                                                @if ($setting->currency_direction == 1)
                                                {{$order->currency_sign}}{{PriceHelper::OrderTotalGST($order)}}
                                                @else
                                                {{PriceHelper::OrderTotalGST($order)}}{{$order->currency_sign}}
                                                @endif
                                            </span>
                                        </td>
                                        </tr>
