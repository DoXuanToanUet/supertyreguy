...
<div class="page-title">
  ...
  <div class="container padding-bottom-3x mb-1 login-form">
    <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-12 col-md-8 col-xl-5">
              <form class="card" method="post" action="{{route('user.login.submit')}}">
                  @csrf
                <div class="card-body ">
                  <h4 class="margin-bottom-1x text-center login-title">{{__('Login')}}</h4>

                  <div class="form-group input-group">
                    <label for="userLogin" class="form-label">Email</label>
                    <input class="form-control" type="email" id="userLogin" name="login_email" placeholder="{{ __('Email') }}" value="{{old('login_email')}}">
                  ...
                  <div class="form-group input-group">
                    ...
                    <input class="form-control" type="password" id="userPassword" name="login_password" placeholder="{{ __('Password') }}" >
                  ...
                  <div class="d-flex flex-wrap justify-content-between padding-bottom-1x login-remember">
                    <div class="custom-control custom-checkbox d-flex  align-items-center">
                      <input class="custom-control-input" type="checkbox" id="remember_me" style="width:18px; height:18px">
                      <label class="custom-control-label ms-2" for="remember_me">{{__('Remember me')}}</label>
                    </div><a class="navi-link" href="{{route('user.forgot')}}">{{__('Forgot password?')}}</a>
                  </div>
                  {{-- <div class="text-center"> --}}
                    <button class="btn btn-block btn-primary margin-bottom-none btn-login" type="submit">{{ __('Login') }}</button>
                  {{-- </div> --}}
                  <div class="row">
