...
class CartController extends Controller
{
    ...
    public function cartServiceAdd(Request $request){
        $req=$request->all();
        $aditinal_data = Session::has('aditional_cost') ? Session::get('aditional_cost') : [];
        $aditinal_data[$req['select_text']]=$req['select_item'];
        
        Session::put('aditional_cost',$aditinal_data);
        if($request->ajax()){
